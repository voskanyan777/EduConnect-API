    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by_teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educonnect_app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Group',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educonnect_app.user')),
            ],
        ),
        migrations.AddField(
            model_name='course',
            name='created_by_teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='educonnect_app.user'),
        ),
    ]
